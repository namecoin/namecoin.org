...
We're happy to announce that Namecoin is [receiving 30,000 EUR](https://nlnet.nl/news/2024/20241003-announcing-Core-call.html) (roughly 32,840 USD) in additional funding from NLnet Foundation's NGI0 Core (Next Generation Internet: Zero Core) Fund. If you're unfamiliar with NLnet, you might want to read [about NLnet Foundation](https://nlnet.nl/foundation/), or just take a look at [the projects they've funded over the years](https://nlnet.nl/thema/index.html) (you might see some familiar names). 
